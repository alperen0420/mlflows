                ...
                script {
                    if (isUnix()) {
                        sh '''
                            ...
                            python -m garak --config garak_config.yaml --report_prefix garak_reports/scan --report_format jsonl
                        '''
                    } else {
                        powershell '''
                            $venv = Join-Path $env:WORKSPACE ".venv"
                            ...
                            & $py -m garak --config garak_config.yaml --report_prefix $outPrefix --report_format jsonl
                        '''
                    }
                }
            }
